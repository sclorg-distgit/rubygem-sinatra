...
Patch0:         ruby200-rubygem-sinatra-rdoc-4-tests-fix.patch
# Fix test_Calculates_the_Content_Length_using_the_bytesize_of_the_body(ResponseTest)
# test error.
# https://github.com/sinatra/sinatra/commit/1286b089b4984e39b3a9e8512f8d45667a3aabed
Patch1:         rubygem-sinatra-1.3.4-adjust-response-tests-for-edge-rack.patch
# Fix test_initializes_with_200_text_html_and_empty_body(ResponseTest) test error.
# https://github.com/sinatra/sinatra/commit/e83153b3b9b831fefc4f8f29db16acb569a894d8
Patch2:         rubygem-sinatra-1.3.4-default-response-content-type-to-html-even-with-newest-rack.patch
# https://github.com/sinatra/sinatra/commit/0ddc7695789b83e955a899612a0a3fc9ad3742cf
Patch3:         rubygem-sinatra-1.3.6-avoid-to_enum-warning-on-2.0.patch
# Do not concatenate params. Fixes Foreman issues.
# https://bugzilla.redhat.com/show_bug.cgi?id=997018
# https://github.com/sinatra/sinatra/commit/e32893491b6d02c86450a9384732696ce5ba78eb
Patch4:         rubygem-sinatra-1.4.0-do-not-concatinate-params.patch
